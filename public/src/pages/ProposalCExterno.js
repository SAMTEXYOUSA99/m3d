...
const ProposalCExterno = () => {
  ...
  const model = null;
  const modelempty = "1. Modelagem 3D externo, conforme projeto e necessidades do cliente; 1.1 - Paredes externas (conforme medidas/croqui recebidas pelo cliente); 1.2 - Terreno; 1.3 - Entorno básico; 1.4 - Muros; 1.5 - Pátio completo, com todos as áreas previstas no projeto arquitetônico e vídeos/fotos do local; 1.6 - Acessos; 1.7 - Paisagismo básico genérico; 1.8 - Entorno básico; 1.9 -Humanização básica; 1.10 - Humanização básica; 1.11 - Cenografia básica; 1.12 - Cenografia avançada;"
    ...
    return (
        <div>
          ...
          <label>
            <input
              type="checkbox"
              value="10 imagens externas 3D realistas FULL HD"
              onChange={handleProjectServiceChange}
            />
            10 imagens externas 3D realistas FULL HD
          </label>
          {/* 
          <label>
            <input
          ...
          <label>
            <input
              type="checkbox"
              value="1 Vídeo externo realista em FULL HD de 60seg."
              onChange={handleProjectServiceChange}
            />
            1 Vídeo externo realista em FULL HD de 60seg.
          </label>
        </div>
      );
  };
  ...
  return (
    ...
    <div className="container">
        <h1>Criação de Proposta de Investimento | Modelo C Externo</h1>
...
export default ProposalCExterno;
