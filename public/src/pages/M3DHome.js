...
import logom3dhomecolortextwhite from '../m3dasset/logom3dhomecolortextwhite.png';

 
import './M3DHome.css';

import ClientsCarousel from '../components/clientscarousel';
import {FooterHome }from '../components/footerm3dhome';
import {BtnDo} from '../components/btn-do';
import {BtnRender} from '../components/btn-render';
import BackGroundMain from '../components/bgmain';
import {LineAbsoluteHome} from '../components/lineabsolute';
import Gallery from '../components/gallery';
import Advantages from '../components/advantage';
import { SocialMediaHome } from '../components/socialmedia';
 ...
 {/*    <NavItem icon={<AiOutlineMenu className='testunic'/>} >
      ...
      <div className='home page'>
        ...
        <div className='content-home'>
          <a href="https://m3dstudio.com.br/"><img src={logom3dhomecolortextwhite} alt="teste" className='logomain'/> </a>
          <h1 className='text-content-home'>VALORIZE SUAS IDEIAS</h1>
          <LineAbsoluteHome />
          <h2 className='text-content-home'>CONECTE-SE COM A M3D HOME</h2>
      ...
      <div className="gradient-line-proj"></div>
        <h1 className="titles-home">PORTFOLIO</h1>
        <Gallery />   
      </div>

      <div className='company page'>
      <div className="gradient-line-proj"></div>
        <h1 className="titles-home">EMPRESA</h1>
...
Contamos histórias através de projetos arquitetônicos, com foco na essência de cada cliente e cada proposta, com extrema fidelidade e originalidade, tornando um sonho, uma realidade 3D.</p>
      ...
      <div className="gradient-line-proj"></div>
        <h1 className="titles-home">CONTATO</h1>
