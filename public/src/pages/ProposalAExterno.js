...
const ProposalAInterno = () => {
  ...
  const model = null;
  const modelempty = "1. Modelagem 3D externo, conforme projeto e necessidades do cliente; 1.1 - Paredes externas conforme planta baixa (croqui, dwg ou pdf) recebida pelo cliente; 1.2 - Terreno; 1.3 - Muros; 1.4 - Pátio completo, com todos as áreas previstas no projeto arquitetônico; 1.5 - Acessos; 1.6 - Paisagismo básico genérico; 1.7 - Entorno básico; 1.8 - Humanização básica;"
  const modeltype = "A";
  ...
  return (
    <div className="global">
      ...
      <div className="container">
        ...
        <h1>Criação de Proposta de Investimento | Modelo A Externo</h1>   
